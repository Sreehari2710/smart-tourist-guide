// components/PlanTripContent.tsx
// This component contains the core logic and UI for planning a new trip.
// It is a client component and uses hooks like useRouter and useSearchParams.
